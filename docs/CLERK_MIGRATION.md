...
3. Create webhook `https://innovators-global.com/api/webhooks/clerk` for `user.created`, `user.updated`, `user.deleted`.
4. Add its secret to Vercel as `CLERK_WEBHOOK_SIGNING_SECRET`.
