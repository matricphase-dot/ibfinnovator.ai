...
import { Github, Sparkles, Loader2, MailCheck, Info, AlertTriangle } from "lucide-react";
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="p-6 md:p-12 flex flex-col">
        ...
        <div className="w-full max-w-md m-auto py-10">
          <div className="mb-6 p-4 border border-amber-300/25 bg-amber-300/[.07] rounded-xl flex gap-3">
            <AlertTriangle className="text-amber-300 shrink-0" size={20} />
            <div>
              <b className="text-sm text-white">Legacy sign-in</b>
              <p className="text-xs text-slate-400 mt-1 leading-5">
                Legacy sign-in. New accounts should use{" "}
